...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3a266022.cluster.x-k8s.io",
	...
	if err = (&controller.WXOneClusterReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "WXOneCluster")
		os.Exit(1)
	}
	if err = (&controller.WXOneMachineReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WXOneMachine")
		os.Exit(1)
	}
	// nolint:goconst
